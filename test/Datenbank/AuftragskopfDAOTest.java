...
public class AuftragskopfDAOTest {
    ...
    */
    ...
    public void testFuegeAuftragHinzu() throws Exception {
        ...
        Auftragskopf auftragskopf = new Auftragskopf("000005", "000006", 
                "Auftragstext", "15.09.2017", "20.01.2017", "30.09.2017", 
                "", "Barauftrag", "1500", "N");       
        AuftragskopfDAO instance = new AuftragskopfDAO();
...
//        Auftragskopf ak = new Auftragskopf();
        String auftragskopfID = "000002";
        AuftragskopfDAO instance = new AuftragskopfDAO();
        String expResult = "1500";
    ...
    public void testGibAlleGeschaeftspartnerKunde() throws Exception {
        ...
        ArrayList<Auftragskopf> result = instance.gibAlleGeschaeftspartnerKunde();
        assertEquals(expResult, result);
    }

    /**
     * Test of gibAlleGeschaeftspartnerLieferant method, of class AuftragskopfDAO.
     * @throws java.lang.Exception
     */
    @Test
